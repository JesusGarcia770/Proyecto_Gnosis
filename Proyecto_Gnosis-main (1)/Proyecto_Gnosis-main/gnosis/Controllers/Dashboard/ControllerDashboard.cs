...
using gnosis.Views.CategoriasBooks;
...
namespace gnosis.Controllers.Dashboard
{
    public class ControllerDashboard
    {
        ...
        public ControllerDashboard(ViewDashboard View, string username)
        {
            ...
            ObjDashboard.categoriasToolStripMenuItem.Click += new EventHandler(AbrirFrmCategorias);
        ...
        private void AbrirFrmCategorias(object sender, EventArgs e)
        {
            AbrirFormulario<ViewCategoriasBooks>();
        }
